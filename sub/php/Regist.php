    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
{
      ...
      // } 
        ...
        //检测学号是否已经存在
        $check_query = mysql_query("SELECT student_id FROM player WHERE student_id='$sno' limit 1");
        if(mysql_fetch_array($check_query)){
          ...
          $status = "1";
          //插入数据库
          $sql = "INSERT INTO player (name,gender,student_id,grade,class,tel,direction,status)
          ...
          //报名结果信息和相关提示
          $regist_status = "成功";
          $regist_info = "报名成功,面试时间: 11 月 14 日 ~ 11 月 15 日,<br>请关注网协公众平台留意最新面试动态，也可以进入官网随时查看面试进度";
          //方向以及年级转换
          $direction=dirction_convert($direction);
          $grade = grade_convert($grade);
          //关闭数据库连接
